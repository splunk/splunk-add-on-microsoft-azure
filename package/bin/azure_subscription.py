...
class ModInputazure_subscription(base_mi.BaseModInput):

    def __init__(self):
        use_single_instance = False
        super(ModInputazure_subscription, self).__init__("ta_ms_aad", "azure_subscription", use_single_instance)
    ...
    def get_scheme(self):
        ...
        scheme.add_argument(smi.Argument("tenant_id", title="Tenant ID",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("azure_subscription_note", title="",
        ...
        scheme.add_argument(smi.Argument("environment", title="Environment",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("source_type", title="Subscription Sourcetype",
                                         description="",
                                         required_on_create=True,
                                         required_on_edit=False))
        return scheme
