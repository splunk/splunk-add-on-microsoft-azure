...
class ModInputMS_AAD_user(base_mi.BaseModInput):

    def __init__(self):
        use_single_instance = False
        super(ModInputMS_AAD_user, self).__init__("ta_ms_aad", "MS_AAD_user", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputMS_AAD_user, self).get_scheme()
        scheme.title = ("Azure Active Directory Users")
        ...
        scheme.add_argument(smi.Argument("environment", title="Environment",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("user_sourcetype", title="User Sourcetype",
                                         description="",
                                         required_on_create=True,
                                         required_on_edit=False))
...
if __name__ == "__main__":
    exitcode = ModInputMS_AAD_user().run(sys.argv)
    sys.exit(exitcode)
