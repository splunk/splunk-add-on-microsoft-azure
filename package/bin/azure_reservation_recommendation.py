...
class ModInputazure_reservation_recommendation(base_mi.BaseModInput):

    def __init__(self):
        use_single_instance = False
        super(ModInputazure_reservation_recommendation, self).__init__("ta_ms_aad", "azure_reservation_recommendation", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputazure_reservation_recommendation, self).get_scheme()
        scheme.title = ("Azure Reservation Recommendation")
        ...
        scheme.add_argument(smi.Argument("subscription_id", title="Subscription ID",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("azure_reservation_note", title="",
        ...
        scheme.add_argument(smi.Argument("environment", title="Environment",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("recommendation_sourcetype", title="Recommendation Sourcetype",
                                         description="",
                                         required_on_create=True,
                                         required_on_edit=False))
        return scheme
...
if __name__ == "__main__":
    exitcode = ModInputazure_reservation_recommendation().run(sys.argv)
    sys.exit(exitcode)
