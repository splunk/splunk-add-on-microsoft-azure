...
class ModInputMS_AAD_signins(base_mi.BaseModInput):
    ...
    def collect_events(helper, ew):
        ...
        if(session):
            ...
            helper.log_debug("_Splunk_ input_name=%s Sign-in URL used: %s" % (input_name, url))
            ...
            while items:
                for item in items:
                    ...
                    this_signinDateTime = item["createdDateTime"]
