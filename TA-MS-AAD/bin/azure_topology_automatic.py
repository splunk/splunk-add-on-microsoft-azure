...
import input_module_azure_topology_automatic as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_topology_automatic.py
'''
class ModInputazure_topology_automatic(modinput_wrapper.base_modinput.BaseModInput):
