...
import input_module_azure_resource_group as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_resource_group.py
'''
class ModInputazure_resource_group(modinput_wrapper.base_modinput.BaseModInput):
