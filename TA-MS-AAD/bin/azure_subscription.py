...
import input_module_azure_subscription as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_subscription.py
'''
class ModInputazure_subscription(modinput_wrapper.base_modinput.BaseModInput):
