...
import input_module_azure_consumption as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_consumption.py
'''
class ModInputazure_consumption(modinput_wrapper.base_modinput.BaseModInput):
