...
import input_module_azure_comp as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_comp.py
'''
class ModInputazure_comp(modinput_wrapper.base_modinput.BaseModInput):
