...
import input_module_MS_AAD_audit as input_module
...
'''
    ...
    Add your modular input logic to file input_module_MS_AAD_audit.py
'''
class ModInputMS_AAD_audit(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def get_scheme(self):
        ...
        scheme.title = ("Microsoft Azure Active Directory Audit")
