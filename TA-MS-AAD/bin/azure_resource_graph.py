...
import input_module_azure_resource_graph as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_resource_graph.py
'''
class ModInputazure_resource_graph(modinput_wrapper.base_modinput.BaseModInput):
