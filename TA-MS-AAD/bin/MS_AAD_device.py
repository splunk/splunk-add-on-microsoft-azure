...
import input_module_MS_AAD_device as input_module
...
'''
    ...
    Add your modular input logic to file input_module_MS_AAD_device.py
'''
class ModInputMS_AAD_device(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def get_scheme(self):
        ...
        scheme.title = ("Microsoft Azure Active Directory Devices")
